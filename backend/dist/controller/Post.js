...
exports.getPostComments =
  ...
  exports.checkPostLikeStatus =
  exports.unLikeThePost =
  exports.likeThePost =
    ...
    try {
      ...
      yield prisma.post_media.create({
        data: {
          ...
          media_url: imgUrl,
          user_id:
            ((_b = req.user) === null || _b === void 0 ? void 0 : _b.id) || -1,
        },
      });
...
const checkPostLikeStatus = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const { postId } = req.body;
    try {
